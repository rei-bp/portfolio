    ...
    return (
        <div className="projects">
            ...
            <div className='card'>
                ...
                <a href='https://admiring-spence-c2dab0.netlify.app' target="_blank" rel="noopener noreferrer"><Image src='/viberant.png' alt='viberant screenshot' height='320vh' width='420vh' /></a>
            </div>
            <div className='card'>
            <a href='https://nba-bite.herokuapp.com' target="_blank" rel="noopener noreferrer"><Image src='/nbabite.png' alt='nba bite screen shot' height='320vh' width='450vh' /></a>
                <div className='descriptionContainer'>
            ...
            <div className='card'>
                ...
                <a href='https://rei-bp.github.io/Magikarp-pro-tourney' target="_blank" rel="noopener noreferrer"><Image className='magikarp' alt='magikarp pro tourney screenshot' src='/mtp.gif' height='320vh' width='450vh' /></a>
            </div>
            <style jsx global>{`
